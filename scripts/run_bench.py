...
# Shared with capture_uart.py so both agree on which tty is the UART. The board
# shows two USB serial devices and ttyUSB0 is not reliably the CH340 -- see
# doc/BRINGUP.md section 13.
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from capture_uart import resolve_port  # noqa: E402
