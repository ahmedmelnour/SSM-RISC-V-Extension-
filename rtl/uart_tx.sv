...
//
// Idle line is high. A write pulse on tx_valid_i latches tx_data_i and shifts
// out start bit, 8 data bits (LSB first), stop bit. Writes while tx_busy_o is
// high are ignored, so software must poll the status register.
// -----------------------------------------------------------------------------
